 ...
 * 
 * Un labyrinthe est repr�sent� par la matrice de ses cases (maze), ses dimensions (width,height) et une fonction pi.
 * 
...
public final class Maze implements GraphInterface {
	...
	/** Ajoute � la liste successors un sommet nextVertex s'il est accessible depuis le sommet vertex
	 * @param vertex Le sommet de d�part
	 * @param nextVertex Le sommet d'arriv�e
	 ...
	 * @throws MazeReadingException Erreur li�e � la lecture du fichier
	 */
	...
	/** Sauvegarde le labyrinthe dans un fichier texte apr�s l'avoir r�solu
	 * @param fileName Adresse du fichier
	 */
